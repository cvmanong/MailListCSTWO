...
public class BookController extends BookAdmin {
    ...
    public void addBook() {
        ...
        boolean addSuccess=bookService.addBook(id,name,0,Integer.parseInt(number),address);
        if(addSuccess){
            queryAll();
        }else{
    ...
    public void updateBook() {
        ...
        boolean updateSuccess=bookService.updateBook(id,name,0,Integer.parseInt(number),address);
        if(updateSuccess){
            queryAll();
        }else{
